...
namespace Vitals
{
    public partial class Vitals_ControlFile : System.Web.UI.Page
    {
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            if (GLActNo.Text != "")
            {
                ...
                string msg = AddVitalControls(
                    ...
                    var emsg = "Record Has Been Added Successfully!";
                if (msg == null)
                {
                    ClientScript.RegisterStartupScript(GetType(), "script", "showMyDialog('" + emsg + "','success" + "');", true);

                }
                else
                    ClientScript.RegisterStartupScript(GetType(), "script", "showMyDialog('" + emsg + "','error" + "');", true);
            }
            else
            {
                var emsg = "Please fill required fields with valid value!";
                ClientScript.RegisterStartupScript(GetType(), "script", "showMyDialog('" + emsg + "','error" + "');", true);
            }
        }
    }
