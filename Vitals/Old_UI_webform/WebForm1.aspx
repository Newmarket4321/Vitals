<%@ Page Title="" Language="C#" MasterPageFile="~/Vitals.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" 
    Inherits="Vitals.WebForm1" MetaKeywords="width=device-width, initial-scale=1" MetaDescription="viewport" %>
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <asp:Button ID="Search" runat="server" Text="Search" Class="btn btn-primary" BackColor="Gray" BorderColor="Gray"  />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
