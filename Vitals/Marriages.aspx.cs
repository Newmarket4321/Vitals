...
namespace Vitals
{
    public partial class Marriages : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            Response.Redirect("Marriages.aspx?id=" + letter + "&certno=" + certno + "&year=" + year + "&regno=" + Regno + "&Restore=tab2&Mode=" + Mode);
        }
        ...
        protected void SubmitBtn_Click(object sender, EventArgs e)
        {
            if (Request.QueryString["id"] == null)
            {
                    ...
                    MarriageDate.Text != "" && Fname.Text != "" && Lname.Text != "")
                {
                   ...
                   // Response.Redirect("Marriages.aspx");
                }
                else
                {
                    var ermsg= "Please fill required filds with valid value!";
            ...
            else
            {
                   ...
                   H_MarriageDate.Text != "" && H_Fname.Text != "" && H_Lname.Text != "")
                {
                    ...
                    Response.Redirect("Marriages.aspx?&Restore=tab2");
                }
                else
                {
                    var ermsg = "Please fill required filds with valid value!";
