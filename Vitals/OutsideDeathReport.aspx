<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLTE.Master" AutoEventWireup="true" CodeBehind="OutsideDeathReport.aspx.cs" Inherits="Vitals.OutsideDeathReport" %>
                    ...
                    <div style="border: thin; border-color: black; color: #005595; font-family: Arial; font-size: 16px;">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Outside Death</h3>
                            </div>
                            <div class="card-body">
                            ...
                            <i class="fa fa-save"></i>&nbsp;Generate Report</asp:LinkButton>
                                ...
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Arial Black"
                                    ...
                                    <LocalReport ReportPath="Reports/OutsideDeath.rdlc">
                                        <DataSources>
